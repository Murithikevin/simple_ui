...
import 'package:simple_ui/views/aboutme.dart';
import 'package:simple_ui/views/bookPage.dart';
import 'package:simple_ui/views/dashboard2.dart';
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const Dashboardprovider ()),
                  );
            },
          ),
        ],
      ...
      body: ListView(
        children: [
          _buildCategory(
            title: 'Account',
            items: [
              {'text': 'Edit Profile', 'icon': Icons.person,   'onTap': () {
